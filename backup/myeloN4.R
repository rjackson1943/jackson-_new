# myeloN4.R Model of Myeloid Cell Maturation and trafficking 25 Nov 2012
#
library(deSolve)
...
fmyelo <- function(Time, State, Pars) {
	with(as.list(c(State, Pars)), {
				...
				return(list(c(dP,dQ,dN,dTN,dAN,dGM,dNAP2,dRAC2,dMcl1,dROS,dBACT,dabl,dil8,dtnfa,dg,dil3,dgsh,dGSSG),
...
X0=c(P=6.466e6, Q=5.655e5, N=4.558e6, TN=7.564e4, AN=76.84,
	 GM=3.97,NAP2=.01004, RAC2=26.59, Mcl1=2.021, ROS=1.967, bact=1e6, abl=0, il8=4, tnfa=0, g=1, il3=1, gsh=1e6, GSSG=0)                                                                            # Starting values for variables
