...
fmyelo <- function(Time, State, Pars) {
	with(as.list(c(State, Pars)), {
				...
				vX.MCL1=Vx.mcl1*(1+BcrAbl/(Kabl2*(1+das/Kdas)))/(1+seli/Kseli)/(1+ifna/Kifna)
...
pars=c(Vx.p=4.25e3, Kil3=1, Vp.p=.0203, Kgm=2, Kcn=100, Vp.n=.026, Kg=1, Kmo=1,
	  ...
	  il8=4,Qf=.0373, volP=2900, volM=1400, volT=65700,        # these are boundary  conditions
...
X0=c(P=1.222e7, Q=1.094e6, N=1.727e7, TN=9.296e5, AN=3875,
	 GM=1.129,NAP2=.01004, RAC2=26.59, Mcl1=2.021, ROS=1.967, bact=0, BcrAbl=5, g=11, il3=51, gsh=1e6, GSSG=0)                                                                                     # Starting values for variables
